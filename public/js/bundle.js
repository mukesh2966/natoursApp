      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log('this is checkout session: ', session); // 2) Create checout form + charge the credit card for us.
...
console.log('this will see if login form is selected', loginForm); // for login
