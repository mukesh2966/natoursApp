...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieG11a2VzaCIsImEiOiJja2RuNDQxd3YwN2U0Mnh0dmp6OWs4ZWg1In0.XfWzW8gtmdI2swecxc0WIg';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // add to the map variable that we created
    // Add PopUP
...
}; // type is eithere 'success' or 'error'


exports.hideAlert = hideAlert;

var showAlert = function showAlert(type, msg) {
  var time = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 7000;
  hideAlert();
  console.log('from aler ', msg);
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                ...
                email: email,
                password: password,
                passwordConfirm: passwordConfirm // role: 'admin',
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alert.showAlert)('success', 'Signned in successfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            } // console.log(res);
          ...
          case 7:
            ...
            document.getElementById('sign').textContent = 'SIGN UP'; // console.log('from login.js', error.response.data.message);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "User ".concat(type.toUpperCase(), " Changed Successfully"));
            } // console.log(res);
...
var stripe = Stripe('pk_test_51HFrYdIqvZZHrC7NoGArvlZ9Ok6VX27la1dnN1e3Dhe4JrayslXhPksI5JUsPdKnEYf6pTxfoBwN4KcBXmyGr26r00dlBPAQFJ');
...
var bookBtn = document.getElementById('book-tour'); // for mapbox
// DELEGation
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    e.preventDefault();
    document.getElementById('sign').textContent = 'Signing Up...';
...
if (updateUserDataForm) {
  updateUserDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); //----RECREATING MULTIPART FORM DATA FUNCTIONALITY of a form enctype attribute
...
if (alertMessage) {
  (0, _alert.showAlert)('success', alertMessage, 20000);
}
